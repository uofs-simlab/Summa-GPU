...
! ***************************************************************************************************************
attributes(host,device) subroutine satVapPress(TC, SVP, dSVP_dT)
IMPLICIT NONE
! input
...
! Based on Tetens' formula (1930)
! ***************************************************************************************************************
attributes(device) FUNCTION SPHM2RELHM(SPHM, PRESS, TAIR)
IMPLICIT NONE
...
! Based on Tetens' formula (1930)
! ***************************************************************************************************************
attributes(device) FUNCTION RELHM2SPHM(RELHM, PRESS, TAIR)
IMPLICIT NONE
...
! ***************************************************************************************************************
attributes(device) FUNCTION WETBULBTMP(TAIR, RELHM, PRESS)
IMPLICIT NONE
! input
